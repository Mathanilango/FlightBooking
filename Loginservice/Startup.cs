...
namespace Adminservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           options.UseSqlServer(@"Data Source=(localdb)\mssqllocaldb;Initial Catalog=FlightLogin; MultipleActiveResultSets=True; Trusted_Connection=True; Integrated Security=True;"));
